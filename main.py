...
fly_surf = pygame.image.load("graphics/platformerGraphicsDeluxePack/Enemies/flyFly1.png").convert_alpha()
...
#intro screen
player_stand = pygame.image.load("graphics/platformerGraphicsDeluxePack/Player/p1_stand.png").convert_alpha()
